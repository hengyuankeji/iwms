...
//正文中输出mp3播放代码 
function showVsbAudio(aurl,vheight,vwidth,vautoplay)
{
	if(aurl=="")
	{
	    return;   
	...
	var outputHTML="";
	outputHTML +='<audio src="'+aurl+'" width="'+vwidth+'" height="'+vheight+'"  '+autoplayStr+'  controls="controls"><embed width="'+vwidth+'" height="'+vheight+'" src="'+playersrc+'" flashvars="'+flashvars+'" /></audio>';
